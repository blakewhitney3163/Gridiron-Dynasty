...
export default function CpuOfferBanner({
  cpuOffer, offerWorking, currentSeason,
  offerIndex, offerCount,
  onAccept, onDecline, onPrev, onNext,
}: Props) {
  ...
  const diffColor = diff >= 0 ? '#4caf50' : '#FF8740';
    ...
    <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginLeft: 'auto' }}>
            ...
            <button
              ...
              style={{
                ...
                fontSize: 14, cursor: offerIndex === 0 ? 'not-allowed' : 'pointer',
            ...
            <button
              ...
              style={{
                ...
                fontSize: 14, cursor: offerIndex === offerCount - 1 ? 'not-allowed' : 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}
            >&#8250;</button>
          </div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, flexWrap: 'wrap' }}>
        ...
        <div style={{ textAlign: 'center', paddingTop: 14 }}>
          ...
          <div style={{ fontSize: 18, fontWeight: 700, color: diffColor }}>
            {diff >= 0 ? '+' : ''}{diff}
          </div>
          <div style={{ fontSize: 9, color: T.textDim }}>
            {diff >= 0 ? 'in your favor' : 'in their favor'}
          </div>
        </div>
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 14, alignItems: 'center' }}>
        ...
        {offerCount > 1 && (
          <span style={{ color: T.textDim, fontSize: 11, marginLeft: 4 }}>
            Declining removes this offer. Use arrows to browse others.
          </span>
        )}
      </div>

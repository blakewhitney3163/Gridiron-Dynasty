...
export async function advanceSeason(): Promise<AdvanceSeasonResult> {
 ...
 SELECT SUM(games) as games, SUM(pass_yards) as pass_yards, SUM(pass_tds) as pass_tds,
 ...
 SUM(CAST(sacks AS REAL)) as sacks, SUM(def_interceptions) as def_interceptions,
